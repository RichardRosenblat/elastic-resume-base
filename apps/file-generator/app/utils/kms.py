...
When ``decrypt_kms_key_name`` is configured in settings, ciphertext field values are
...
def decrypt_field(ciphertext_b64: str, decrypt_kms_key_name: str) -> str:
    ...
    When *decrypt_kms_key_name* is empty the function treats *ciphertext_b64* as
    ...
    try:
        ...
        response = client.decrypt(
            request={"name": decrypt_kms_key_name, "ciphertext": ciphertext}
        )
