...
const configSchema = z.object({
  ...
  ingestorServiceTimeoutMs: z.number().optional(),
  searchBaseServiceTimeoutMs: z.number().optional(),
  fileGeneratorServiceTimeoutMs: z.number().optional(),
  documentReaderServiceTimeoutMs: z.number().optional(),
  userApiServiceTimeoutMs: z.number().optional(),
  dlqNotifierServiceTimeoutMs: z.number().optional(),
...
function loadConfig(): Config {
  return configSchema.parse({
    ...
    ingestorServiceTimeoutMs: safeParseInt(process.env['INGESTOR_SERVICE_TIMEOUT_MS']),
    searchBaseServiceTimeoutMs: safeParseInt(process.env['SEARCH_BASE_SERVICE_TIMEOUT_MS']),
    fileGeneratorServiceTimeoutMs: safeParseInt(process.env['FILE_GENERATOR_SERVICE_TIMEOUT_MS']),
    documentReaderServiceTimeoutMs: safeParseInt(process.env['DOCUMENT_READER_SERVICE_TIMEOUT_MS']),
    userApiServiceTimeoutMs: safeParseInt(process.env['USER_API_SERVICE_TIMEOUT_MS']),
    dlqNotifierServiceTimeoutMs: safeParseInt(process.env['DLQ_NOTIFIER_SERVICE_TIMEOUT_MS']),
