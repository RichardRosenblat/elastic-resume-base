module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@elastic-resume-base/aegis/server$': '<rootDir>/../../shared/Aegis/v2/aegis_ts/src/server/index.ts',
    '^@elastic-resume-base/aegis/client$': '<rootDir>/../../shared/Aegis/v2/aegis_ts/src/client/index.ts',
    '^@elastic-resume-base/aegis$': '<rootDir>/../../shared/Aegis/v2/aegis_ts/src/server/index.ts',
    '^@elastic-resume-base/aegis-v1$': '<rootDir>/../../shared/Aegis/v1/aegis_ts/src/index.ts',
    '^@elastic-resume-base/aegis-v1/client$': '<rootDir>/../../shared/Aegis/v1/aegis_ts/src/client.ts',
    '^@elastic-resume-base/harbor/server$': '<rootDir>/../../shared/Harbor/v3/harbor_ts/src/server/index.ts',
    '^@elastic-resume-base/harbor/client$': '<rootDir>/../../shared/Harbor/v3/harbor_ts/src/client/index.ts',
    '^@elastic-resume-base/harbor$': '<rootDir>/../../shared/Harbor/v3/harbor_ts/src/server/index.ts',
