module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@elastic-resume-base/harbor/server$': '<rootDir>/../../shared/Harbor/v2/harbor_ts/src/server/index.ts',
    '^@elastic-resume-base/harbor/client$': '<rootDir>/../../shared/Harbor/v2/harbor_ts/src/client/index.ts',
