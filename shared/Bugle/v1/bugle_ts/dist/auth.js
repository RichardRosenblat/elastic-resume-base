...
function parseServiceAccountKey() {
    ...
    try {
        ...
        throw new Error('Failed to parse GOOGLE_SERVICE_ACCOUNT_KEY: value must be a valid JSON object ' +
 ...
 * ```
 */
export function getGoogleAuthClient(scopes = DRIVE_READONLY_SCOPES) {
