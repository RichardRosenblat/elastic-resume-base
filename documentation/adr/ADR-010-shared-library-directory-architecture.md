...
|---------|-----------|--------|--------------------------|
| Aegis | ✅ | ✅ | `shared/Aegis/v1/aegis_ts` (v1 TS), `shared/Aegis/v2/aegis_ts` (v2 TS, active), `shared/Aegis/v2/aegis_py` (v2 Python, active) |
| Bowltie | ✅ | ✅ | `shared/Bowltie/v1/bowltie_ts`, `shared/Bowltie/v1/bowltie_py` |
| Bugle | ✅ | ✅ | `shared/Bugle/v1/bugle_ts`, `shared/Bugle/v1/bugle_py` |
| Harbor | ✅ | ✅ | `shared/Harbor/v1/harbor_ts`, `shared/Harbor/v1/harbor_py` (v1), `shared/Harbor/v2/harbor_ts` (v2 TS, active), `shared/Harbor/v2/harbor_py` (v2 Python, active) |
