...
This document defines the coding standards and best practices for the Node.js BFF Gateway service in the Elastic Resume Base project. All contributors must follow these guidelines to ensure consistency, maintainability, and security across the codebase.
