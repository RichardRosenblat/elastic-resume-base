...
import { proxyToDocumentReaderApi } from '../services/documentsProxyService.js';

/**
 * Fastify catch-all handler that transparently proxies any unmatched request
 * under `/api/v1/documents/*` to the Document Reader service.
 *
 ...
 *   inside {@link proxyToDocumentReaderApi}.
...
export async function documentsProxyHandler(
  ...
  logger.info(
    ...
    'documentsProxyHandler: transparent proxy forwarding unmatched Document Reader request',
  );
